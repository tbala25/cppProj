...
//    for(int i = 0; i < 8; i++){
//        for(int j = 0; j < 8; j++){
//            SDL_SetRenderDrawColor(renderer, pieces.at(i+j).getR(),
//                                    pieces.at(i+j).getG(), pieces.at(i+j).getB(), 255);
//            SDL_Rect a = makeNewRect(x, y, hXw, hXw);
